...
<div class="my_info_cart">
 <div class="my_info_cart_title">
       <a class="actives"><?php echo $woo_language_a2; ?></a>
...
echo '<div class="no_order_in_here"><p>'.$woo_language_a3.'</p><p><a href="'.$order_urls2.'">'.$woo_language_a4.'</a><a href="'.$cart.'">'.$woo_language_a5.'</a></p></div>';
