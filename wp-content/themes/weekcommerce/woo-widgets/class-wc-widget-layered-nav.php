 ...
 * @extends  WC_Widget
 */
class WC_Widget_Layered_Nav_t extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_name        = __( '[产品筛选]产品属性筛选', 'woocommerce' );
		parent::__construct();
	}
	...
	public function widget( $args, $instance ) {
		...
		echo '<div class="widget woocommerce widget_price_filter widget_attributes_filter"><div class="widget_title_t">'.$instance['title'].'：</div>';
...
if($count > 0 ){
			...
			echo ( $count > 0 || $option_is_set ) ? '<a class="'.$filter_name.'" data="'.$term->slug.'" href="' . esc_url( apply_filters( 'woocommerce_layered_nav_link', $link ) ) . '">' : '<span>';
