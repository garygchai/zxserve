...
function new_seo_box() {
  ...
  <label for="page_fix_bag"><strong>描述替换（不填写自动调用文章第一段前200字）：</strong>
    ...
    <em>一般不超过200个字</em>
     ...
     <div style="  width:width:100%;padding:5px 0; display:block;overflow: hidden;">
      <select id="gallery_tlye">
	        
			 <option value=''>点击放大的图片列表</option>
             <option value='modle1'>左右旋转的大图</option>

	</select>
    <p>【付费版解锁】付费版提供相册功能，可为你提供点击放大的图片列表和左右切换的幻灯片</p>
    <p>需要帮助？<a target="_blank" href="https://www.themepark.com.cn/wkscwoocommercegjztspjc.html">[观看视频教程]</a></p>
     </div>
      <?php   
