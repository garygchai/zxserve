...
$customize_title = sprintf( __( 'Customize &#8220;%s&#8221;' ), $ct->display('Name') );
 ?>
        <p><b>主题名称：<?php echo $ct->display('Name'); ?></b> <a class="banben">版本：<?php echo $ct->display('Version'); ?></a>
         <a  href=" http://www.themepark.com.cn/wkxdwoocommerce-wordpresszt.html" target="_blank" class="jieshao">主题详细介绍</a> 
        <a href="http://www.themepark.com.cn/category/woocommerce/" target="_blank" class="bangzhu">视频教程</a></p>
        <p><b>主题出品：</b><a target="_blank" href="http://www.themepark.com.cn"><?php echo $ct->display('Author'); ?></a>  <a href="http://www.themepark.com.cn/category/woocommerce/" target="_blank">进入woocommerce专区（视频教程、拓展插件）</a></p>
        ...
        <form method="post" action=""class="xuanxiangka">
             ...
             <DIV id=con>
                   <UL id=tags>
                       ...
                       <LI><div class="tb2"></div><A onClick="selectTag('tagContent0',this)" href="javascript:void(0)">略缩图设置</A> </LI>
                  
                       <LI><div class="tb4"></div><A onClick="selectTag('tagContent2',this)" href="javascript:void(0)">seo以及其他</A> </LI>
