...
class WC_Swatches_Product_Attribute_Images {
	...
	public function woocommerce_add_attribute_thumbnail_field() {
		...
		<div class="form-field ">
			<label for="product_attribute_swatchtype_<?php echo $this->meta_key; ?>">选择属性显示方式</label>
			<select name="product_attribute_meta[<?php echo $this->meta_key; ?>][type]" id="product_attribute_swatchtype_<?php echo $this->meta_key; ?>" class="postform">
		                ...
		                <option value="color">颜色选项</option>
		                <option value="photo">图片选项</option>
			</select>
		...
		<div class="form-field swatch-field swatch-field-color section-color-swatch" style="overflow:visible;display:none;">
			<div id="swatch-color" class="<?php echo sanitize_title($this->meta_key); ?>-color">
		                ...
		                <input class="woo-color"   id="product_attribute_color_<?php echo $this->meta_key; ?>"  type="text"  name="product_attribute_meta[<?php echo $this->meta_key; ?>][color]" value="#FFFFFF" />
			</div>
		</div>
	...
	public function woocommerce_edit_attributre_thumbnail_field($term, $taxonomy) {
		...
		<tr class="form-field ">
			...
			<td>
		                ...
		                <select name="product_attribute_meta[<?php echo $this->meta_key; ?>][type]" id="product_attribute_swatchtype_<?php echo $this->meta_key; ?>" class="postform">
					<option <?php selected('text', $swatch_term->get_type()); ?> value="text"><?php _e('默认文字', 'wc_swatches_and_photos'); ?></option>
					<option <?php selected('color', $swatch_term->get_type()); ?> value="color"><?php _e('颜色显示', 'wc_swatches_and_photos'); ?></option>
					<option <?php selected('photo', $swatch_term->get_type()); ?> value="photo"><?php _e('图片显示', 'wc_swatches_and_photos'); ?></option>
		                </select>
